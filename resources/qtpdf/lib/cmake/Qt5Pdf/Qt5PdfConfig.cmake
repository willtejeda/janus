...
set(Qt5Pdf_VERSION_STRING 5.9.0)
...
macro(_populate_Pdf_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::Pdf PROPERTIES
        "INTERFACE_LINK_LIBRARIES" "${_Qt5Pdf_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5Pdf_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::Pdf)
    ...
    set(Qt5Pdf_PRIVATE_INCLUDE_DIRS
        "${_qt5Pdf_install_prefix}/include/QtPdf/5.9.0"
        "${_qt5Pdf_install_prefix}/include/QtPdf/5.9.0/QtPdf"
    )
    ...
    foreach(_module_dep ${_Qt5Pdf_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.0 ${_Qt5Pdf_FIND_VERSION_EXACT}
    ...
    _populate_Pdf_target_properties(RELEASE "Qt5Pdf.dll" "Qt5Pdf.lib" )



    _populate_Pdf_target_properties(DEBUG "Qt5Pdfd.dll" "Qt5Pdfd.lib" )
