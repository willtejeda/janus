...
private:
    ...
    TextureHandle* m_texture_handles_right[ASSETSHADER_NUM_COMBINED_TEXURES];
...
public:
    ...
    inline MeshHandle* GetMeshHandle() const
	{
		return m_mesh_handle;
	}

    inline ProgramHandle* GetShader() const
	{
		return m_shader;
	}
...
public:
    ...
    virtual std::shared_ptr<ProgramHandle> GetDefaultObjectShaderProgram() = 0;
    ...
    virtual std::shared_ptr<TextureHandle> CreateCubemapTextureHandleFromAssetImages(QVector<QPointer<AssetImageData>>& p_skybox_image_data, const bool tex_mipmap, const bool tex_linear, const bool tex_clamp, const TextureHandle::ALPHA_TYPE tex_alpha, const TextureHandle::COLOR_SPACE tex_colorspace) = 0;
    virtual std::shared_ptr<TextureHandle> CreateTextureFromAssetImageData(QPointer<AssetImageData> data, bool is_left, const bool tex_mipmap, const bool tex_linear, const bool tex_clamp, const TextureHandle::ALPHA_TYPE tex_alpha, const TextureHandle::COLOR_SPACE tex_colorspace) = 0;
    ...
    virtual void BindBufferHandle(BufferHandle * p_buffer_handle) = 0;
	virtual void ConfigureBufferHandleData(std::shared_ptr<BufferHandle> p_buffer_handle, uint32_t const p_data_size, void* const p_data, BufferHandle::BUFFER_USAGE const p_buffer_usage) = 0;
	virtual void UpdateBufferHandleData(std::shared_ptr<BufferHandle> p_buffer_handle, uint32_t const p_offset, uint32_t const p_data_size, void* const p_data) = 0;
    ...
    virtual std::shared_ptr<MeshHandle> GetTexturedCubeVAO() = 0;
    virtual GLuint GetTexturedCubePrimCount() const = 0;
    virtual std::shared_ptr<MeshHandle> GetTexturedCube2VAO() = 0;
    virtual GLuint GetTexturedCube2PrimCount() const = 0;
    virtual std::shared_ptr<MeshHandle> GetTexturedCube3VAO() = 0;
    virtual GLuint GetTexturedCube3PrimCount() const = 0;
    virtual std::shared_ptr<MeshHandle> GetPortalStencilCylinderVAO() = 0;
    virtual GLuint GetPortalStencilCylinderPrimCount() const = 0;
    virtual std::shared_ptr<MeshHandle> GetPortalStencilCubeVAO() = 0;
    virtual GLuint GetPortalStencilCubePrimCount() const = 0;
    virtual std::shared_ptr<MeshHandle> GetPlaneVAO() = 0;
    virtual GLuint GetPlanePrimCount() const = 0;
    virtual std::shared_ptr<MeshHandle> GetDiscVAO() = 0;
    virtual GLuint GetDiscPrimCount() const = 0;
    virtual std::shared_ptr<MeshHandle> GetConeVAO() = 0;
    virtual GLuint GetConePrimCount() const = 0;
    virtual std::shared_ptr<MeshHandle> GetCone2VAO() = 0;
    virtual GLuint GetCone2PrimCount() const = 0;
    virtual std::shared_ptr<MeshHandle> GetPyramidVAO() = 0;
