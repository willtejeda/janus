...
private:
    ...
    QVector<std::shared_ptr<TextureHandle>> left_texture_handles;
	QVector<uint> right_textures;
    QVector<std::shared_ptr<TextureHandle>> right_texture_handles;
...
public:
    ...
    void SetUploadedTexture(std::shared_ptr<TextureHandle> left_id, std::shared_ptr<TextureHandle> right_id);
    std::shared_ptr<TextureHandle> GetLeftTextureHandle(int index);
    std::shared_ptr<TextureHandle> GetRightTextureHandle(int index);
};
