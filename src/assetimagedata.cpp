...
void AssetImageData::SetUploadedTexture(std::shared_ptr<TextureHandle> left_id, std::shared_ptr<TextureHandle> right_id)
{
...
std::shared_ptr<TextureHandle> AssetImageData::GetLeftTextureHandle(int index)
{
...
std::shared_ptr<TextureHandle> AssetImageData::GetRightTextureHandle(int index)
{
...
void AssetImageData::SetLeftTextureHandle(int index, std::shared_ptr<TextureHandle> id)
{
    if (index >= 0)
    {
...
void AssetImageData::SetRightTextureHandle(int index, std::shared_ptr<TextureHandle> id)
{
    if (index >= 0)
    {
