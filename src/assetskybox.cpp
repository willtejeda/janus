...
TextureHandle* AssetSkybox::GetTextureHandle()
{
    ...
    return (m_texture_handle != nullptr) ? m_texture_handle.get() : m_asset_images[0]->GetTextureHandle(true);
}
