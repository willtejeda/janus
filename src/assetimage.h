...
public:
    ...
    TextureHandle* GetTextureHandle(const bool left_eye);
    //unsigned int GetTextureManagerIndex() const;
    ...
    static std::shared_ptr<TextureHandle> null_cubemap_tex_handle;
    static std::shared_ptr<TextureHandle> null_image_tex_handle;
