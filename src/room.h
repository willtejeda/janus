...
class Room : public QObject
{
    ...
    Q_PROPERTY(QVariantMap room MEMBER room_jsproperties)
    Q_INVOKABLE void createasset(QString asset_type, QVariantMap property_list);
    Q_INVOKABLE void createobject(QString object_type, QVariantMap property_list);   
...
public:
    ...
    QList <QPointer <Room> > GetVisibleRooms();
...
private:   
    ...
    void Create_Custom_Translator(const QString translator_name);
    ...
    //new JS stuff for custom translators    
    QVariantMap room_jsproperties;
    QPointer <AbstractWebSurface> room_jsengine;
    QString room_jsengine_translator_filename;    
