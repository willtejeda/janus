...
public:
    ...
    TextureHandle* GetTextureHandle(MediaContext * ctx);
    TextureHandle* GetLeftTextureHandle(MediaContext * ctx);
    TextureHandle* GetRightTextureHandle(MediaContext * ctx);
